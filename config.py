...
""",
    ...
    'onetime_tasks': [  # tasks to execute
        ...
        # 增强功能：多账号每日任务、周常乐园、截图保存
        ["src.task.CustomDailyTask", "CustomDailyTask"],
        ["src.task.WeeklyParadiseTask", "WeeklyParadiseTask"],
        ["src.task.ScreenshotTask", "ScreenshotTask"],
    ...
    # 增强功能：自定义 GUI Tab
    'custom_tabs': [
        ["src.gui.DailyTaskConfigTab", "DailyTaskConfigTab", FluentIcon.FOLDER, "每日任务配置"],
        ["src.gui.ActivityManagerTab", "ActivityManagerTab", FluentIcon.EVENT, "活动管理"],
    ],
}
